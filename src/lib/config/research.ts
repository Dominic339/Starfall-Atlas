...
export const RESEARCH_DEFS: readonly ResearchDefinition[] = [
  ...
  ...buildSequentialDefs(
    ...
    "fleet_command",
    [
      "Establishes multi-ship coordination protocols. Unlocks 1 fleet slot. Fleet travel speed +2 ly/hr.",
      "Expands command bandwidth for larger formations. Unlocks 2 fleet slots. Fleet travel speed +4 ly/hr total.",
      "Distributed fleet AI reduces coordination latency. Unlocks 3 fleet slots. Fleet travel speed +6 ly/hr total.",
      "Advanced tactical overlay for large-scale operations. Unlocks 4 fleet slots. Fleet travel speed +8 ly/hr total.",
      "Full strategic command suite. Unlocks 5 fleet slots. Fleet travel speed +10 ly/hr total.",
    ],
  ...
  ...buildSequentialDefs(
    ...
    "fleet_formation",
    [
      "Basic geometric formations improve fleet cohesion. Allows fleets of 2 ships. +15% asteroid harvest power.",
      "Dynamic formation switching during transit. Allows fleets of 4 ships. +30% harvest power total.",
      "Adaptive formation AI responds to threats in real-time. Allows fleets of 8 ships. +45% harvest power total.",
      "Staggered micro-jump coordination. Allows fleets of 12 ships. +60% harvest power total.",
      "Synchronized formation-jump capability. Allows fleets of 20 ships. +75% harvest power total.",
    ],
    [300, 800, 2000, 5000, 12000],
    [
      undefined,
  ...
  ...buildSequentialDefs(
    ...
    "extraction",
    [
      "Improved drilling protocols increase raw resource yield by +10% per node per hour.",
      "Automated extraction rigs running at +20% — continuous uptime with minimal downtime.",
      "Deep-core extraction reaches richer ore seams. Total extraction bonus: +30%.",
      "Particle-sieve refinery improves ore grade before shipping. Total bonus: +40%.",
      "Quantum-stabilised extraction at near-theoretical efficiency. Total bonus: +50%.",
    ],
  ...
  ...buildSequentialDefs(
    ...
    "growth",
    [
      "Improved habitat construction standards reduce population growth time by 10%.",
      "Advanced agricultural systems accelerate colony expansion. Growth 20% faster total.",
      "Synthetic food production eliminates environmental growth limits. Growth 30% faster total.",
      "Distributed healthcare networks extend productive lifespans. Growth 40% faster total.",
      "Post-scarcity welfare systems maximise population growth. Growth 50% faster total.",
    ],
    [200, 600, 1500, 4000, 10000],
    undefined,
    false,
  ...
  ...buildSequentialDefs(
    ...
    "sustainability",
    [
      "Efficient iron recycling reduces colony upkeep consumption by 10%.",
      "Closed-loop life support reduces upkeep consumption by 20% total.",
      "Fusion power eliminates dependency on imported fuel. Upkeep reduced by 30%.",
      "Fully self-sustaining colony cycles. Upkeep reduced by 40%.",
      "Zero-net-import colony design. Upkeep reduced by 50%.",
    ],
    [200, 600, 1500, 4000, 10000],
    undefined,
    false,
  ...
  ...buildSequentialDefs(
    ...
    "storage",
    [
      "Prefabricated storage units increase colony storage cap by +200 units.",
      "Automated warehouse systems increase colony storage cap by +400 units total.",
      "Orbital container platforms increase colony storage cap by +600 units total.",
      "Distributed micro-warehouse grid increases colony storage cap by +800 units total.",
      "Planetary-scale storage network increases colony storage cap by +1000 units total.",
    ],
    [200, 600, 1500, 4000, 10000],
    undefined,
    false,
