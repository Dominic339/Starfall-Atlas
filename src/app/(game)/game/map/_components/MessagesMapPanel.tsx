...
export function MessagesMapPanel({ onClose }: MessagesMapPanelProps) {
  ...
  return (
    ...
    >
      <div className="relative w-full max-w-xl max-h-[88vh] flex flex-col rounded-lg border border-zinc-700 bg-zinc-950 shadow-2xl overflow-hidden animate-fade-in-up">
